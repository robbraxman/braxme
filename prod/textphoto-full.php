...
<BODY class="" style='width:100%;padding:0;margin:0' >
    
    <div class="pagetitle2a" style='text-align:center;margin:auto;color:black'>
        <img class='icon25' src='../img/text-photo-greatlake-128.png' />
        <b>Social Media Hack - Convert Text to Image</b>
    </div>
        <div class="smalltext" style='text-align:center;margin:auto;color:black;padding:20px'>
            Convert your text to an image to create unsearchable content<br>which can then be shared as a photo on social media.
            <br><br>
                <span class='textphotodemo' style='color:steelblue;cursor:pointer'>Demo1 </span>
                &nbsp;&nbsp;
                <span class='textphotodemo2' style='color:steelblue;cursor:pointer'>Demo2</span>
        </div>
        <table  class="gridnoborder mainfont" style='padding-top:0;margin-top:0;margin:auto;max-width:90%'>
        <tr class='mainfont' style='margin:0;padding:0'>
            <td>    
               Public Comment - Convert to Image<br>
                ...
                <div class="divbutton3 divbutton3_unsel createsamplebutton" id="createsamplebutton">
                    <img class='icon20' src='../img/brax-photo-round-lawn-128.png' style='' />
                    Preview Image</div>

...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $installfolder = "") {
        ...
        $this->options = array(
            ...
            'file_types'=> array("png","jpg","jpeg","gif","tiff","tif","doc","docx","ppt","pptx","xls","xlsx","pages","keynote","numbers","zip","mp3","wav","mp4","m4a","m4v","mov","tar","gz","au","qt","mov","txt","rtf","apk","ipa","xml","csv","html","htm","pps","csv","pdf","mobi","epub","3gp","ogv","webm"),
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            foreach ($upload['tmp_name'] as $index => $value) {
                ...
                if($this->options['braxmode'] === 'FILES')
                    $this->braxmeimport($file_path);
                if($this->options['braxmode'] === 'PHOTOS')
                    $this->braxmeimportphotos($file_path);
                /* Brax.Me End */
    ...
    //Brax.ME
    protected function braxmeimport($origfilename) {
            ...
            $result = do_mysqli_query("1", 
                    "
                        ...
                        values
                        ( $providerid, '$attachmentfilename','$encrypted_origfilename', '$filefolder',$fsize, '$filenameext','$encrypted_subject', now(), '$alias','$encoding', 'Y' ) 
                     "
             );
                    

            putAWSObject("$attachmentfilename",$upload_dir.$origfilename);
    ...
    protected function braxmeimportphotos($origfilename) {

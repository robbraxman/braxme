...
<body style='max-height:100%;overflow-x:hidden;overflow-y:auto;background-color:transparent;position:absolute;left:0px;top:0px;width:100%;padding:0;margin:0'>
<div id='fixedbackground' class='' style='
...
<div id='animationlayer' class='' style='
...
<div class='consolebody' style='z-index:10;border:0;position:absolute;top:0;left:0;background-color:transparent;padding:0;margin:0;width:100%;max-width:100%;'>
    ...
    <div class='gridnoborder' style='display:none' id="loading-div-background">
        <div id="loading-div" class="ui-corner-all" >
          <img style="height:100px;margin:10px;" src="../img/loading-blue.gif" alt="Loading.."/>
    ...
    <table class='gridnoborder' style='padding:0;margin:0;width:100%'>
        <tr class='gridnoborder' style='width:100%;padding:0;margin:0'>
            <td class='gridnoborder pagetitle2 sidemenuarea'  style='display:none;background-color:<?=$global_menu_color?>;padding:10px;min-width:150px;color:<?=$global_textcolor?>;vertical-align:top;overflow-y:scroll'>
            </td>
                       ...
                       width:100%;margin:0;text-align:left;background-color:<?=$global_banner_color?>">
                        ...
                        <span class='nonmobile'>
                             <div class="smalltext bannerheight" 
                                  style='display:inline-block;color:white;padding:0;
                                  margin:0px;'>
                                 &nbsp;&nbsp;<?=$loginuser?>
                             </div>
                        </span>
                        <div class='opensidemenu tapped menubutton formobile' 
                            style='display:inline;float:right;cursor:pointer;padding-right:20px;padding-left:5px;padding-bottom:0px;'>
                            <?=$beacon?>
                            <img class='tip1 icon30' src='../img/menu-circle-128.png' 
                                 style=";top:6px;;cursor:pointer;"  title="Main Menu" />
                        </div>
                        <div class='camera formobile tapped menubutton' 
                            ...
                            <img class='icon30' src='../img/camera-circle-128.png' 
                                 style=";top:6px;;cursor:pointer;" title="Camera" />
                        </div>
                    </div>
                </span>            
                <div class='tileview gridnoborder' style='display:none;background-color:transparent;overflow-y:scroll;overflow-x:hidden;width:100%'>
                </div>
                ...
                <div class='mainview gridnoborder' 
                    ...
                    <table id='mainviewtop gridnoborder' class="panelhost mainfont" style="background-color:transparent;width:100%;height:auto;margin:0;padding:0px;border-spacing:0;border:0">
                        <tr class='gridnoborder' style="padding:0;margin:0;background-color:transparent;width:100%">
                                ...
                                <td class="sidebararea nonmobile gridnoborder noselect" style="color:white;background-color:<?=$global_menu_color?>;padding:0;max-width:300px;margin:0px;max-height:100%" valign="top">
                                    <div class='sidebar mainfont'  style='background-color:<?=$global_menu_color?>;padding-top:10px'>
                                        <center>
                                            ...
                                            <div class='smalltext2' style='padding-left:10px;padding-top:3px'><?=$loginuser?></div>
                                        </center>
                                        <div class='sidebaralerts noselect' style='background-color:<?=$global_menu_color?>'></div>
                                    </div>
                                </td>
                                ...
                                <td class='maincontentarea gridnoborder' style="background-color:transparent;padding:0;margin:0;width:100%;border:0;border-spacing:0" valign="top">
                                    ...
                                    <div class='settingsview' data-colorscheme='<?=$_SESSION['colorscheme']?>' data-sponsorcolorscheme='<?=$_SESSION['sponsorcolorscheme']?>'
                                         ...
                                         style="display:none;overflow:auto;background-color:transparent;text-align:left;color:<?=$global_textcolor?>;max-width:100%;">
...
<div class='hidespace' style='overflow:hidden;display:inline;height:0;background-color:transparent'>
    ...
    <div id=trigger_notifysubscribe class='notifysubscribe mainbutton' style='display:none'></div>
    <div id=trigger_room class='mainbutton feedload' data-roomid='' data-mode='' style='display:none'></div>
    ...
    <FORM id='ageform' name='age'  ACTION='ageconfirm.php' METHOD='POST' target='functioniframe'  >
    <INPUT TYPE='hidden' NAME='pid'  value='<?=$_SESSION['pid']?>' >
    <INPUT class='timestamp' TYPE='hidden' NAME='timestamp' value='' >
    </FORM>

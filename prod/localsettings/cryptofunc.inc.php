...
//*********************************************************************************
    ...
    function PassE2EKey($chatid, $passkey64, $senderid, $recipientid)
    {
        ...
        "
            ...
            values
            ( $chatid, $recipientid, $senderid, now(), '$passkeyNew64','JS' );
        "
        );
    ...
    function PassE2EKeyHandleRequests($chatid, $passkey64, $senderid )
    {
        ...
        while($row = do_mysqli_fetch("1",$result) ){
            ...
            do_mysqli_query("1",
            "
                delete from keysend where providerid = $recipientid and passkey='' and chatid = $chatid
            ");
    ...
    function PassE2EKeyMakeRequest($chatid, $providerid )
    {
        ...
        do_mysqli_query("1",
        "
            delete from keysend where providerid = $providerid and passkey='' and chatid=$chatid
        ");
        ...
        while($row = do_mysqli_fetch("1",$result) ){
            ...
            "
                ...
                ( chatid, providerid, senderid, expiration, passkey, encoding ) 
                values
                ( $chatid, $providerid, $senderid, now(), '','JS' );
            "
            );

    ...
    if( MobileFlag === 'Y'){
        ...
        function SubmitCheck()
        {
            ...
            if($('#industry3').is(':checked') && $('#replyemail').val()==='' ){
                alertify.alert('An Email is required for Enterprise Accounts');
                return false;
            }
        ...
        <table style='margin:auto'>
            ...
            <td>
                ...
                <table  class='rounded' style='border-size:1px;border-color:gray;background-color:whitesmoke;;width:300px;padding:20px;margin:auto;font-size:13px;font-family:"Helvetica",Helvetica,Arial,san-serif;font-weight:200'  autocomplete='false'>
                    ...
                    <td class=dataarea>
                        <input id='industry1' type='radio' name='industry' class='industrygroup'  style='cursor:pointer;position:relative;top:5px' checked=checked value='personal'> Personal (Free)
<?php
if($_SESSION['language']=='english'){
?>
                        <span class='browseronly''>
                            <br>
                            <input id='industry3' type='radio' name='industry' class='industrygroup'  style='cursor:pointer;position:relative;top:5px' value='enterprise'> <?=$enterpriseapp?>
                            <!--
                            <br>
...
echo LanguageLinks("$rootserver/$installfolder/invite.php?gcm=$gcm&apn=$apn","float:right","$global_activetextcolor");
echo "</div>";
?>

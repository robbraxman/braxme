...
?>
        ...
        <div style='text-align:center;width:100%;margin:auto;padding:20px;background-color:transparent;color:<?=$global_textcolor?>'>
            ...
            <div class='gridstborder smalltext' style='margin:auto;background-color:transparent;text-align:center;vertical-align:center;width:100%;max-width:500px;cursor:pointer'>
                ...
                <div class='colorchoice' style='cursor:pointer;border:2px solid white;padding-top:15px;float:left;height:40px;width:100px;background-color:#6699ff;;color:white' data-mode='S' data-colorscheme='beach' >beach</div>
                ...
                <div class='colorchoice' style='cursor:pointer;border:2px solid white;padding-top:15px;float:left;height:40px;width:100px;background-color:#1a9955;;color:white' data-mode='S' data-colorscheme='lawn' >lawn</div>
                <div class='colorchoice' style='cursor:pointer;border:2px solid white;padding-top:15px;float:left;height:40px;width:100px;background-color:#227093;;color:white' data-mode='S' data-colorscheme='skyblue' >skyblue</div>
                <div class='colorchoice' style='cursor:pointer;border:2px solid white;padding-top:15px;float:left;height:40px;width:100px;background-color:#3c6382;;color:white' data-mode='S' data-colorscheme='riverblue' >riverblue</div>
                ...
                <div class='colorchoice' style='cursor:pointer;border:2px solid white;padding-top:15px;float:left;height:40px;width:100px;background-color:#1b1b1b;color:white' data-mode='S' data-colorscheme='school night' >school night</div>
